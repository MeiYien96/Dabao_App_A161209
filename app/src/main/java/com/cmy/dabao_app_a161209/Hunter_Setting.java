...
public class Hunter_Setting extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner3 = (Spinner) findViewById(R.id.spi_restaurant);
        ...
        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(this,
                R.array.restaurant, android.R.layout.simple_spinner_item);
